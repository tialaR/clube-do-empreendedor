  ...
  return (
    <TermsButtonContainer>
      <TermsButtonText>
        ...
        <TermsButtonText>{'\ndo '}</TermsButtonText>
        <TermsButtonText bold>{' Clube do Empreendedor'}</TermsButtonText>
      </TermsButtonText>
    </TermsButtonContainer>
  );
};
  ...
  return (
    <Container>
      ...
      <BodyContainer>
        <BodyContainerContents>
          <WellcomeContainer>
            <WellcomeText>Bem-vindo ao Clube!</WellcomeText>
            <WellcomeDescription>
              {
          ...
          <ButtonsContainer>
            <Button
              filled
              onPress={() => navigation.navigate('SignIn', {isClient: true})}>
              Cliente
            </Button>
            <SpacingY small />
            <Button
              outlined
              onPress={() => navigation.navigate('SignIn', {isClient: false})}>
              Empresa
            </Button>
          </ButtonsContainer>
